...
(def-doom-theme doom-ayu-light
  ...
  (((line-number &override) :foreground (doom-lighten fg 0.7))
   ...
   (mode-line-highlight :foreground common-fg :background common-accent)
   ...
   ;;;; org-super-agenda
   (org-agenda-date-today :box t :foreground "#6ab6ec")
   (org-agenda-date :box t :foreground "#a37acc")
   (org-agenda-date-weekend :box t :foreground "#b594d6")
   ))
